...
<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
            ...
            <table id="dataGrid" class="table table-striped table-bordered b-t">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <input type="hidden" value="${row.content}" class="tb-content-hd"/>
                    ...
                    <#--<@shiro.hasPermission name="message:view">-->
                        <td class="text-center">
                        <#--<#if row.id != 1>-->
                            <#--<a href="${base}/admin/message/transmit_message?id=${row.id}"-->
                            <a href="#"
        ...
        <div class="x_content">
            <@pager "/admin/message/log?status=${status}" page 5 key/>
        </div>
        <#else>
            暂无消息
        </#if>
...
<script type="text/javascript">
    ...
    $(function () {
        ...
        // 标记为已读
        $('#dataGrid a[data-action="read"]').bind('click', function () {
            var that = $(this);
            layer.confirm('确定将该信息标记为已读?', {
                btn: ['确定', '取消'], //按钮
                shade: false //不显示遮罩
            }, function () {
