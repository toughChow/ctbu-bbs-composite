        ...
        <div class="x_panel">
            ...
            <div class="x_content">
                <form id="qForm" class="form-inline">
                    ...
                    <button type="button" class="btn btn-default addTypea">添加类型</button>
                </form>
            </div>
            <div class="x_content">
            ...
            <div class="modal fade addTypeb" data-backdrop="static">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h4 class="modal-title" id="myModalLabel">添加帖子类型</h4>
                        </div>
                        <form class="form-horizontal" action="${base}/admin/posts/add_postType" method="post"
                              onsubmit="return submitTest()">
                            <div class="modal-body">
                                <div class="form-group">
                                    <lable class="col-sm-2 control-label" for="inputGroupName">类型名称<em>*</em></lable>
                            ...
                            <div class="modal-footer">
                                <button type="button" class="btn btn-default closeaddTypeb">关闭</button>
                                <button type="submit" class="btn btn-primary" id="addGroup">提交更改</button>
                            </div>
                        </form>
                    </div><!-- /.modal-content -->
