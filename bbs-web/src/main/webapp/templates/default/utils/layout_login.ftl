...
<head>
    ...
    <meta name="keywords" content="smartlamp,$!{site_keywords}">
    ...
    <!-- Favicons -->
    <link rel="apple-touch-icon-precomposed" href="http://smartlamp.com/assets/images/logo/m99.png"/>
    <link rel="shortcut icon" href="http://smartlamp.com/assets/images/logo/m.png"/>
