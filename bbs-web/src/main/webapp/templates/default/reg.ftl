...
<div class="login">
    ...
    <form action="reg" method="post">
        ...
        <div id="id_email">
            <input maxlength="18" class="form-control border" name="username" value="${post.username}" placeholder="用户名"
        ...
        <div id="id_name">
            <input maxlength="9" class="form-control border" name="name" value="${post.name}" placeholder="昵称"
                   type="text" data-required>
        </div>
        <label for="id_name">邮箱:</label>
        <div id="id_name">
            <input maxlength="64" class="form-control border" name="email" value="${post.email}" placeholder="邮箱地址"
